...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-border bg-gradient-header px-4 py-3 shadow-soft sm:px-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex w-full flex-wrap items-center gap-3">
          ...
          <div className="hidden min-w-[260px] flex-1 items-center gap-2 rounded-lg bg-white/10 px-3 py-2 md:flex md:min-w-[280px]">
        ...
        <div className="flex w-full flex-wrap items-center justify-end gap-3 sm:flex-nowrap">
          ...
          <Link to="/scan" className="w-full sm:w-auto">
            <Button
              variant="outline"
              size="sm"
              className="w-full border-white/30 text-primary-foreground/90 hover:bg-white/10"
            >
          ...
          <Button
            variant="ghost"
            size="sm"
            className="relative w-full justify-center text-primary-foreground hover:bg-white/10 sm:w-auto"
          >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-10 w-full rounded-full sm:w-10">
